...
version = release = stream_tap.__version__
...
man_pages = [
    ('index', 'stream_tap', u'stream_tap Documentation',
...
texinfo_documents = [
  ('index', 'stream_tap', u'stream_tap Documentation',
   u'John W Lockwood IV', 'stream_tap', 'Capture data from iterators as they'
                                        ' are pulled down stream.',
   'Miscellaneous'),
]
